      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-start">
        ...
        <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-100 overflow-hidden lg:sticky lg:top-24 lg:max-h-[calc(100vh-160px)] flex flex-col transition-all">
          <div className="flex items-center gap-3 mb-4 md:mb-6 shrink-0">
            <BookOpen className="text-indigo-600" size={20} md:size={24} />
            <h2 className="text-xl md:text-2xl font-black text-slate-800 tracking-tight">Reading Passage</h2>
          </div>
          <div className="overflow-y-auto lg:pr-4 space-y-4 md:space-y-6">
            <h3 className="text-lg md:text-xl font-bold text-indigo-700 underline underline-offset-8 decoration-indigo-200 leading-tight">
              {MOCK_PASSAGE.title}
            </h3>
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100">
            <div className="flex items-center justify-between mb-6 md:mb-8">
              <h2 className="text-lg md:text-xl font-bold text-slate-800 tracking-tight">Questions 1-3</h2>
